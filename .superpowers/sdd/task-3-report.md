...
$ vitest run
 ...
 ✓ src/features/auth/components/AuthGuard.test.tsx (4 tests) 29ms
 ✓ convex/__tests__/schema.test.ts (1 test) 3ms
 ✓ convex/__tests__/authorization.test.ts (20 tests) 26ms

 Test Files  4 passed (4)
      Tests  26 passed (26)
   Start at  16:38:01
   Duration  895ms (transform 179ms, setup 0ms, import 507ms, tests 60ms, environment 2.34s)
```
...
- **Quality**: Strong type safety, clean separation of concerns, and clean verbatim imports syntax.
